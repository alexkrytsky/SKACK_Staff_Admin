...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Ubuntu+Mono"
        rel="stylesheet">
  <link href="smart_wizard.min.css"
        rel="stylesheet"
        type="text/css"/>
...
<body>
<? require_once "../../headerUserNew.html"; ?>
<div class="container">
  <div class="row">
    <form action='submit-wizard.php'>
      <div id="smartwizard"
        ...
        <ul>
          ...
          <li><a class='h4'
                 href="#contacts">Contacts<br/>
              <small>Information</small>
            </a></li>
          <li><a class='h4'
                 href="#medical">Medical<br/>
              <small>Information</small>
            </a></li>
          <li><a class='h4'
                 href="#emergency-contacts">Emergency Contacts<br/>
              <small>Information</small>
            </a></li>
          <li><a class='h4'
        ...
        <div>
          ...
          <div id="contacts"
               class="">
            <h2>Contacts - Contact Information</h2>
            <hr>
            <div class='container'>
              <div class='row'>
          ...
          <div id="medical"
               class="">
            <h2>Medications - Medications and Dosage Information</h2>
            <hr>
            <div class='row'>
          ...
          <div id="emergency-contacts"
               class="">
            <h2>Emergency Contacts - Emergency Contact Information</h2>
            <hr>
            <div class='container'>
              <div class='row'>
              ...
              <div class='row'>
                <button class='btn btn-primary'
                        ...
                        id='wizard-emergency-contacts-button-add'>
                  ...
                  <div class='row justify-content-end'>
                      <div class='col-9'>
                          <div class="input-group mb-3">
                              ...
                              <div class='input-group-append'>
                                  <label class='input-group-text'
                                         for='wizard-handbook-checkbox-agreement'>I agree to release this information.</label>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      <div class='modal-dialog modal-lg'
        ...
        <div class='modal-content'>
          ...
          <div class='modal-footer bg-secondary btn-toolbar'>
            ...
            <button id='contact-add-button-confirm'
                    type='button'
...
<!--    Add Emergency Contact Modal-->
      ...
      <div class='modal-dialog modal-lg'
        ...
        <div class='modal-content'>
          ...
          <div class='modal-footer bg-secondary btn-toolbar '>
            ...
            <button id='emergency-contact-confirm-button'
                    type='button'
                    class='btn btn-warning'
  ...
  <script type="text/javascript"
          src="jquery.smartWizard.min.js"></script>
  <script>
